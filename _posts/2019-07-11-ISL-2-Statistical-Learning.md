...
* Simple example
  ...
  * <u>Advertising data set</u> consists of the sales of that product in 200 different markets, along with advertising budgets for the product in each of those markets for three different media: TV, radio, and newspaper.
  * Goal: develop an accurate model that can be used to <u>predict sales on the basis of the three media budgets</u>

  ![1552280161824](C:\Users\이명진\AppData\Roaming\Typora\typora-user-images\1552280161824.png)

  * The advertising budgets are __input variables__. (=__predictors__, __independent variables__, __features__, __variables__)
    * $$X_1$$ might be the TV budget, $$X_2$$ the radio budget, and $$X_3$$ the newspaper budget.
  * The sales is an __output variable__. (=__response__, __dependent variable__)
    * $$Y$$

* We observe a quantitative response $$Y$$ and $$p$$ different predictors, $$X_1$$,$$X_2$$, ..., $$X_p$$.
